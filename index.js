...
exports.generateSdk = exports.apiGateway = void 0;
...
const generateSdk = (apiKey, rootPath) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
  ...
  `;
    ...
    fs.readFile(zipName, (err, data) => {
        if (err)
            throw err;
        const zip = new JSZip();
        zip.loadAsync(data).then((zipContents) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
