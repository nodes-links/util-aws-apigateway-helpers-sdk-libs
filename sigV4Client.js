...
exports.sigV4ClientFactory.newClient = function (config) {
    ...
    awsSigV4Client.accessKey = utils_1.utils.assertDefined(config.accessKey, 'accessKey');
    awsSigV4Client.secretKey = utils_1.utils.assertDefined(config.secretKey, 'secretKey');
    awsSigV4Client.sessionToken = config.sessionToken;
    awsSigV4Client.serviceName = utils_1.utils.assertDefined(config.serviceName, 'serviceName');
    awsSigV4Client.region = utils_1.utils.assertDefined(config.region, 'region');
    awsSigV4Client.endpoint = utils_1.utils.assertDefined(config.endpoint, 'endpoint');
